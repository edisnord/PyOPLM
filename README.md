...
## Features
 ...
 - Comes packaged with Python translations of [bchunk](https://github.com/extramaster/bchunk), [binmerge](https://github.com/putnam/binmerge) and [cue2pops](https://github.com/israpps/cue2pops), making this package officially *cross-platform* (yay!)
...
The latest version is 0.72 (Do not download anything older, this app is under heavy development)
